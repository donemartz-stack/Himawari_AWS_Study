...
output_file = os.path.join(output_folder, 'himawari_aws_10AM_to_4PM_hourly.xlsx')
...
filtered_df = df[(df['Timestamp PH Time'].dt.hour.between(12, 16)) & 
    (df['Timestamp PH Time'].dt.minute == 0)]
